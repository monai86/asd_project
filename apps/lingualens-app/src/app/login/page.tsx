  ...
  return (
    <main className="min-h-screen px-4 py-8 sm:px-6 lg:px-8">
      <div className="mx-auto grid max-w-6xl gap-6 lg:grid-cols-[1fr_420px]">
        <section>
          <p className="mb-3 inline-flex rounded-md border border-cyan-100 bg-cyan-50 px-2.5 py-1 text-xs font-semibold text-cyan-950">
            Runtime-aware access surface
          </p>
          <h1 className="text-3xl font-semibold tracking-normal text-ink sm:text-4xl">lingualens</h1>
          <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-700">
            ...
            Login behavior follows the configured runtime auth mode and app-access policy.
          </p>
          <div className="mt-6">
            <WorkflowVisual />
          </div>
