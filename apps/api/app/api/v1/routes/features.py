...
def extract(transcript_id: str, payload: FeatureExtractionRequest | None = None, repo: MockRepository = Depends(get_repository)):
...
def get_features(session_id: str, repo: MockRepository = Depends(get_repository)):
