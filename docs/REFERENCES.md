...
## 11. Model Trust, Reporting & Clinical AI Evaluation

**Collins, G. S., Dhiman, P., Andaur Navarro, C. L., et al. (2024).** TRIPOD+AI statement: updated guidance for reporting clinical prediction models that use regression or machine learning methods. *BMJ.* https://www.bmj.com/content/385/bmj.q902
> **ใช้เพราะ:** กรอบรายงาน prediction model: dataset, predictors, missing data, validation, calibration, limitations

**Vasey, B., Nagendran, M., Campbell, B., et al. (2022).** DECIDE-AI: new reporting guidelines to bridge the development-to-implementation gap in clinical artificial intelligence. *BMJ.* https://www.bmj.com/content/377/bmj-2022-070904
> **ใช้เพราะ:** กรอบ early clinical evaluation สำหรับ AI decision support, human workflow, failure modes, clinician oversight

**Steyerberg, E. W. (2019).** Clinical Prediction Models: A Practical Approach to Development, Validation, and Updating. Springer.
> **ใช้เพราะ:** อ้างอิง calibration, discrimination, validation และ clinical usefulness ของ prediction models
...
> **ใช้เพราะ:** ที่มาของ decision curve / net benefit ที่เพิ่มใน Model Trust Dashboard
...
> **ใช้เพราะ:** กรอบ transparency, responsibility, inclusiveness, privacy และ safety สำหรับ AI health

---

## 12. Additional Future References (ถ้าจะต่อยอด)
