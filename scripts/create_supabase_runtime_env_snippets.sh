...
THERAPIST_APP_V2_JOB_QUEUE_MODE=${STAGING_JOB_QUEUE_MODE:-<durable-managed-mode>}
THERAPIST_APP_V2_SECRET_STORE_PROVIDER=${STAGING_SECRET_STORE_PROVIDER:-<managed-secret-store-provider>}
THERAPIST_APP_V2_OBSERVABILITY_ENABLED=true
THERAPIST_APP_V2_OBSERVABILITY_PROVIDER=${STAGING_OBSERVABILITY_PROVIDER:-<approved-observability-provider>}
THERAPIST_APP_V2_CRITICAL_ALERT_ROUTE=${STAGING_CRITICAL_ALERT_ROUTE:-<critical-alert-route>}
...
THERAPIST_APP_V2_REPOSITORY_MODE=sql
THERAPIST_APP_V2_STORAGE_MODE=supabase_private
THERAPIST_APP_V2_JOB_QUEUE_MODE=${PRODUCTION_JOB_QUEUE_MODE:-<durable-managed-mode>}
THERAPIST_APP_V2_SECRET_STORE_PROVIDER=${PRODUCTION_SECRET_STORE_PROVIDER:-<managed-secret-store-provider>}
THERAPIST_APP_V2_OBSERVABILITY_ENABLED=true
THERAPIST_APP_V2_OBSERVABILITY_PROVIDER=${PRODUCTION_OBSERVABILITY_PROVIDER:-<approved-observability-provider>}
THERAPIST_APP_V2_CRITICAL_ALERT_ROUTE=${PRODUCTION_CRITICAL_ALERT_ROUTE:-<critical-alert-route>}
