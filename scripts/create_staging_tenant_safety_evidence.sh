...
TEMPLATE_PATH="$ROOT_DIR/docs/templates/STAGING_TENANT_SAFETY_EVIDENCE_TEMPLATE.md"
OUTPUT_DIR="${OUTPUT_DIR:-$ROOT_DIR/docs/release_artifacts/tenant_safety}"
DATE_STAMP="$(date +%Y-%m-%d)"
TIME_STAMP="$(date +%H%M%S)"
SLUG="${1:-staging-tenant-safety}"
