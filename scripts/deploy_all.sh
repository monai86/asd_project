...
cd public-screening
npm run build
npx wrangler pages deploy dist --project-name=asd-public-screening
cd ..
...
npm run build
npx wrangler pages deploy dist --project-name=asd-therapist-clinician
cd ..
...
npm run build
npx wrangler pages deploy dist --project-name=asd-presentation-dashboard
cd ..
