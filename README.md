...
- **Therapist app version:** `v1.3.0`
- **Public screening app version:** `v1.3.0`
- **Presentation dashboard version:** `v1.3.0`
...
### 2. 🩺 Therapist / Clinician App (`therapist-clinician-app/`) [v1.3.0]
